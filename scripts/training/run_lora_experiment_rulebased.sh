#!/bin/bash
# PLUTO LoRA fine-tuning experiment using rule-based score filters.
#
# The rule-based filters are generated by:
#   llm-taxonomy/scripts/experiments/pluto/create_rulebased_filters.py
#
...
ensure_rulebased_filters() {
    ...
    if [ "$missing" -ne 0 ]; then
        echo ""
        echo "Generate or copy rule-based/common-valid filters into:"
        echo "  ${PLUTO_FILTER_DIR}"
        exit 1
    fi
}
...
echo "=============================================="
echo "PLUTO LoRA Curriculum Experiment (Rule-based)"
echo "=============================================="
...
echo ""
echo "=============================================="
echo "EXPERIMENT: Rule-based curriculum fine-tuning"
echo "=============================================="
...
echo "Stage 2/3: rule-based weighted curriculum"
run_lora_train \
    "$STAGE2_EXP" \
    "checkpoint" \
    "$STAGE1_CKPT" \
...
echo "Stage 3/3: rule-based hard-capped curriculum"
run_lora_train \
    "$STAGE3_EXP" \
    "checkpoint" \
    "$STAGE2_CKPT" \
...
echo ""
echo "=============================================="
echo "Done: Rule-based curriculum experiment complete"
echo "=============================================="
