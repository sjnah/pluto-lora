...
UNIFORM_CURRICULUM_VERSION="${UNIFORM_CURRICULUM_VERSION:-v4.3.13}"
CURRICULUM_BASE_EXP="${CURRICULUM_BASE_EXP:-curriculum_lora_uniform_only_${UNIFORM_CURRICULUM_VERSION}}"
